          ...
          <div className="pt-6 lg:flex lg:items-center lg:w-2/5">
            <div className="lg:w-full md:h-56 rounded-md md:p-3 lg:bg-gray-200 xl:h-65">
              ...
              <div className="w-full flex justify-center  mt-4 md:mt-10">
                <button className="py-2 px-4 md:w-64 md:items-self-center rounded-md bg-green-300 md:py-4  md:px-3">
                  <a href="/api/auth/login" className="text-sm md:text-2xl ">Experimentar!</a>
                </button>
              </div>
            </div>
          </div>
          <div className="w-full mt-5 flex justify-center items-center ">
            <Image className="w-4/5 lg:w-5/5 " src={imgHome} alt="home do site" />
          </div>
        </section>
      </main>
      </>
