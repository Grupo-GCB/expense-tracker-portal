...
export const SUCESS_UPDATE_MESSAGE =
  "Atualização da carteira realizada com sucesso.";
export const ERROR_UPDATE_MESSAGE =
  "Erro ao realizar a atualização da carteira.";
...
export const categoryTypes: IOptions[] = Object.entries(Categories).map(
  ([value, label]) => ({
    value,
    label,
  })
